...
public class Label implements Comparable<Label> {
	...
	public boolean hasIntersection(Label other) {
	...
	public List<Label> intersect(Label other) {
		...
		if (this.getTimeInterval().intersect(other.getTimeInterval()) == null) {
	...
	public static List<Label> mergeLabels(List<Label> labels) {
		if (labels.size() <= 1) {
			return labels;
		}
	 ...
	 * @return
	 */
	public static List<Label> insertLabel(List<Label> labels, Label newLabel) {
		...
		if (intersected.size() == 1) {
			...
			return Label.mergeLabels(noIntersections);
		}
		...
		if (intersected.size() == 2) {
			...
			Collections.sort(result);
			return Label.mergeLabels(result);
		}
	...
	public static void main(String[] args) {
		...
		System.out.println(Label.mergeLabels(new Label(2, new TimeInterval(2, 4)).intersect(new Label(1, new TimeInterval(1,  3)))));
		System.out.println(new Label(2, new TimeInterval(1, 3)).intersect(new Label(1, new TimeInterval(0,  5))));
		System.out.println(Label.mergeLabels(new Label(2, new TimeInterval(1, 3)).intersect(new Label(1, new TimeInterval(0,  5)))));
		System.out.println();
		...
		System.out.println(Label.insertLabel(existingLabels, new Label(0, new TimeInterval(0, 1))));
		System.out.println(Label.insertLabel(existingLabels, new Label(0, new TimeInterval(3, 4))));
		System.out.println(Label.insertLabel(existingLabels, new Label(5, new TimeInterval(3, 4))));
		System.out.println(Label.insertLabel(existingLabels, new Label(0, new TimeInterval(0, 11))));
		System.out.println(Label.insertLabel(existingLabels, new Label(4, new TimeInterval(10, 10))));
